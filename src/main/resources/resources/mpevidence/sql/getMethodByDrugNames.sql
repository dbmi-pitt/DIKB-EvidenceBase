...
WHERE ((o.concept_code = '@conceptcode1' AND LOWER(o.vocabulary_id) = '@vocabularyid1') AND (s.concept_code = '@conceptcode2' AND LOWER(s.vocabulary_id) = '@vocabularyid2'))
OR ((s.concept_code = '@conceptcode1' AND LOWER(s.vocabulary_id) = '@vocabularyid1') AND (o.concept_code = '@conceptcode2' AND LOWER(o.vocabulary_id) = '@vocabularyid2'))
