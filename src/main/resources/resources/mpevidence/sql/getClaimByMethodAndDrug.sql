...
SELECT method.mp_claim_id, method.mp_data_index, s.claim_text, method.method, s.qvalue as subject, p.qvalue as relationship, o.qvalue as object, s.qualifier_role_concept_code, o.qualifier_role_concept_code
from method
