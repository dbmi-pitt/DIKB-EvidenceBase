...
WHERE (s.concept_code = '@conceptcode' AND s.qualifier_role_concept_code = '@roleconceptcode' AND s.vocabulary_id in('RxNorm', 'MESH', 'NDFRT')) OR (o.concept_code = '@conceptcode'
 AND o.vocabulary_id in('RxNorm', 'MESH', 'NDFRT') AND o.qualifier_role_concept_code = '@roleconceptcode');
